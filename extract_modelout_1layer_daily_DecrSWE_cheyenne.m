...
tpn1 = 'Decr_April1SWE_WY2012'; % no, tp, snotel
...
for dy=11:11
    ...
    diroutname=['/glade/scratch/abolafia/Drought_Fire_Snow/NoahMP/Outputs/Decr_April1SWE_WY2012/analysis/',tpn];
    if exist(diroutname,'dir')==0
        CMD_mk=['mkdir -p ',diroutname];
        system(CMD_mk);
    end
    fnameout = ['/glade/scratch/abolafia/Drought_Fire_Snow/NoahMP/Outputs/Decr_April1SWE_WY2012/analysis/',tpn,'/daily_2D_WY',num2str(yr_num(2)),'_',tpn,'.nc'];
