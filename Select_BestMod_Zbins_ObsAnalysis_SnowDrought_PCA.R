...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods.csv")
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_2vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_3vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_4vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_5vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_6vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_7vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_8vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_9vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_10vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)
...
best_is=store_i
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_11vars.csv")
write.table(best_is,file=outfilename,sep=",",row.names = FALSE)

# best_mods_idx = read.csv("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods.csv",sep=",",header=TRUE)
...
# ids=combo_IDs[,i]
# 
# #perform eigan value analysis: 
# zs = var(Covariates_DF)
# #perform Eigen decomposition:
# zsvd = svd(zs)
# #prinipal components:
# pcs = t(t(zsvd$u) %*% t(Covariates_DF) )
# #Eigen values: - fraction of variance
# lambdas = (zsvd$d/sum(zsvd$d))
# 
# #backout pcs from eigen values and original variables:
# predictor1 <-Covariates_DF[,1]
# predictor2 <-Covariates_DF[,2]
# predictor3 <-Covariates_DF[,3]
# predictor4 <-Covariates_DF[,4]
# predictor5 <-Covariates_DF[,5]
# predictor6 <-Covariates_DF[,6]
# predictor7 <-Covariates_DF[,7]
# pc1_eigen = zsvd$u[,1]
# pc1_backout = predictor1*pc1_eigen[1] + predictor2*pc1_eigen[2] + predictor3*pc1_eigen[3] + predictor4*pc1_eigen[4] + predictor5*pc1_eigen[5] + predictor6*pc1_eigen[6] + predictor7*pc1_eigen[7]
# #in matrix notation ...
# PC1 = pc1_eigen %*% t(Covariates_DF)
# PC1 = as.vector(PC1)
# plot(pc1_backout,pc1)
