...
%% load in data:
Good_mods = readtable('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Good_Mods_SWEImod_PCA_lowerPeakSWE.csv');
...
for i=1:nmods
    ...
    infilename=sprintf('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_GAM_Zbins_mod%d_SWEImod_PCA_lowerPeakSWE.csv',mod_id);
    ...
    infilename=sprintf('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_mod%d_SWEImod_PCA_lowerPeakSWE.csv',mod_id);
...
box on
ylim([0 7])
saveas(f,'/Users/abolafia/Drought_Fire_Snow/Plots/BA_predict_1984_2020_Obs_GAM_timeseries_SWEImod_PCA_lowerPeakSWE_fit.eps','epsc')
...
%include 1:1 line
plot(linspace(0,6.5,10),linspace(0,6.5,10),'--k','linewidth',4)
...
saveas(f,'/Users/abolafia/Drought_Fire_Snow/Plots/BA_predict_1984_2020_Obs_GAM_scatter_SWEImod_PCA_lowerPeakSWE_fit.eps','epsc')
...
box on
ylim([0 7])
saveas(f,'/Users/abolafia/Drought_Fire_Snow/Plots/BA_predict_1984_2020_Obs_GAM_timeseries_SWEImod_PCA_lowerPeakSWE_drop1.eps','epsc')
...
grid on
f.Position = [139    58   887   746];
saveas(f,'/Users/abolafia/Drought_Fire_Snow/Plots/BA_predict_1984_2020_Obs_GAM_scatter_SWEImod_PCA_lowerPeakSWE_drop1.eps','epsc')
