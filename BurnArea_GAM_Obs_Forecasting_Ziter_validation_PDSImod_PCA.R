...
for (j in 1:nmods){
  ...
  if (Drop1_Ann_Cor >=  sqrt(0.0)) {
    ...
    outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_GAM_Zbins_mod%d_PDSImod_PCA.csv",i)
    ...
    outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_mod%d_PDSImod_PCA.csv",i)
    write.table(standar_error,file=outfilename,sep=",",row.names = FALSE)
  }
}
outfilename = sprintf("/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Good_Mods_PDSImod_PCA.csv")
