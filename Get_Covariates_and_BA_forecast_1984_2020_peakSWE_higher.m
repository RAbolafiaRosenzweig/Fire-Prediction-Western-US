...
for Ziter = 1:length(Z_thresh_mins)
    ...
    outfilename_csv=sprintf('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Annual_Fire_Climate_Obs_forecast_Ziter%d_higherPeakSWE.csv',Ziter);
