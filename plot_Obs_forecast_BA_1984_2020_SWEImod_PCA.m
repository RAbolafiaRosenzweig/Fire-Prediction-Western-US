...
%% load in data:
Good_mods = readtable('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Good_Mods_SWEImod_PCA.csv');
Good_mods = table2array(Good_mods);
nmods = length(Good_mods);
years = 1984:2020;

goodmods = readtable('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_SWEImod_PCA_bestmods_8vars.csv');
goodmods=table2array(goodmods);
...
for i=1:nmods
    ...
    infilename=sprintf('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_GAM_Zbins_mod%d_SWEImod_PCA.csv',mod_id);
    ...
    infilename=sprintf('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Best_Obs_Forecast_outputs/BAs_1984_2020_Obs_Forecast_SE_Zbins_mod%d_SWEImod_PCA.csv',mod_id);
...
sprintf('simulated increasing trend: %.2f/year',p(1)/mean(ensemble_mean)*100)
p2 = plot(years,Annual_BA_obs,'-r','linewidth',3);
%include trend line:
p=polyfit(years,Annual_BA_obs,1);
y = @(x) p(1)*x + p(2);
plot(years,y(years),'--r','linewidth',2)
sprintf('observed increasing trend: %.2f/year',p(1)/mean(Annual_BA_obs)*100)
...
saveas(f,'/Users/abolafia/Drought_Fire_Snow/Plots/BA_predict_1984_2020_Obs_GAM_scatter_SWEImod_PCA_fit.eps','epsc')
...
box on
ylim([0 6])
saveas(f,'/Users/abolafia/Drought_Fire_Snow/Plots/BA_predict_1984_2020_Obs_GAM_timeseries_SWEImod_PCA_drop1.eps','epsc')
...
grid on
f.Position = [139    58   887   746];
saveas(f,'/Users/abolafia/Drought_Fire_Snow/Plots/BA_predict_1984_2020_Obs_GAM_scatter_SWEImod_PCA_drop1.eps','epsc')
