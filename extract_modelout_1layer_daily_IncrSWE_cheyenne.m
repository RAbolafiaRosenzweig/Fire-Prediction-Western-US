...
tpn1 = 'Incr_April1SWE_WY2012'; % no, tp, snotel
tpn2 = 'Basecase_WY2012'; % no, tp, snotel
...
for dy=11:11
    ...
    dir_path1 = ['/glade/scratch/abolafia/Drought_Fire_Snow/NoahMP/Outputs/',tpn1,'/'];
    dir_path2 = ['/glade/scratch/abolafia/Drought_Fire_Snow/NoahMP/Outputs/',tpn2,'/'];
    ...
    for imon = 1:length(mon_ind)
        ...
        for iday = 1:nday_m
            ...
            idx_fill = find(abs(FSA_hr) > 10^30);
            FSA_hr(idx_fill) = NaN;
            FIRA_hr(idx_fill) = NaN;
            GRDFLX_hr(idx_fill) = NaN;
            HFX_hr(idx_fill) = NaN;
            LH_hr(idx_fill) = NaN;
            ETRAN_hr(idx_fill) = NaN;
            EDIR_hr(idx_fill) = NaN;
            SWE_hr(idx_fill) = NaN;
            SNOWH_hr(idx_fill) = NaN;
            ACSNOW_hr(idx_fill) = NaN;
            ACSNOM_hr(idx_fill) = NaN;
            ALBEDO_hr(idx_fill) = NaN;
            SOIL_M_hr(idx_fill) = NaN;
            SOIL_T_hr(idx_fill) = NaN;
    ...
    diroutname=['/glade/scratch/abolafia/Drought_Fire_Snow/NoahMP/Outputs/Incr_April1SWE_WY2012/analysis/',tpn];
    if exist(diroutname,'dir')==0
        CMD_mk=['mkdir -p ',diroutname];
        system(CMD_mk);
    end
    fnameout = ['/glade/scratch/abolafia/Drought_Fire_Snow/NoahMP/Outputs/Incr_April1SWE_WY2012/analysis/',tpn,'/daily_2D_WY',num2str(yr_num(2)),'_',tpn,'.nc'];
