...
for Ziter = 1:length(Z_thresh_mins)
    ...
    outfilename=sprintf('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/Merged_BA/Supplementary/BA_covariates_Obs_forecast_Ziter%d.mat',Ziter);
    ...
    outfilename_csv=sprintf('/Volumes/Pruina_External_Elements/DroughtFireSnow/Data/AnlysisData/Annual_Fire_Climate_Obs_forecast_Ziter%d.csv',Ziter);
